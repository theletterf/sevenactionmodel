---
title: "Introdução"
description: "Por que razão existe o modelo de documentação de sete ações."
scope: "introduction"
---
...
A maioria dos modelos de documentação existentes concentra-se nas ações dos redatores técnicos em vez de se concentrar nas ações dos utilizadores, isto é, dos *consumidores* da documentação. A ênfase prescritiva sobre os documentos que devem ser produzidos, em vez de descrever as necessidades dos utilizadores a que se deve responder, faz lembrar uma mentalidade arquitetónica em que se constroem paredes porque *é evidente que uma casa tem de ter divisões, o que somos nós, bárbaros*? Esta aparente falta de flexibilidade desencoraja a escrita dos conteúdos realmente necessários.

Algumas das pessoas que conceberam modelos de documentação estão conscientes deste problema e sugeriram que as suas regras não devem ser seguidas à letra e que há espaço para flexibilidade na sua aplicação ao mundo real. Os redatores que utilizam esses modelos também enfrentaram este dilema e, na maioria dos casos, acabaram por os adaptar aos seus contextos. Os modelos tornam-se assim conjuntos de ferramentas dos quais se escolhem estruturas e ideias. Este padrão, porém, evita a pergunta sobre o que é realmente necessário.

Perante a complexidade de documentar produtos em rápida evolução com poucos recursos e pouco apoio, os redatores aproveitam tudo o que conseguem e constroem com isso um processo funcional. Por outro lado, os engenheiros que começam a experimentar a documentação e se sentem perdidos ao aproximarem-se da área são atraídos pelos modelos, porque é a única forma de trabalhar a que estão habituados na programação. A documentação que acabam por desenvolver é uma versão de culto da carga de uma documentação eficaz.

## Mudar o foco dos tipos de conteúdo para as necessidades dos utilizadores

Uma solução para esta situação é mudar o foco daquilo que deve ser escrito para as necessidades dos utilizadores a que se deve responder. Isto exige assumir a responsabilidade pelo lado estratégico da documentação — no sentido de estratégia de conteúdo — em vez de produzir conteúdos segundo padrões estruturais predefinidos. Esta abordagem é totalmente compatível com modelos de documentação como o Diátaxis, o DITA e outros, porque dá direção e propósito a quem constrói a documentação, que poderá então usar os tipos de conteúdo, os elementos e as ferramentas ao seu dispor.
...
## O modelo de documentação de sete ações
